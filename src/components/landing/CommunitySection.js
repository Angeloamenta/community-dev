...
export default function CommunitySection() {
  ...
  return (
    <section className="pt-16 pb-10 sm:pt-20 sm:pb-14" id="community">
      <SectionReveal variant="up">
        <div className="relative space-y-8">
          ...
          <div className="grid gap-6 md:grid-cols-[minmax(0,1.6fr)_minmax(0,1.2fr)] relative z-10">
            ...
            {/* Blocco stile IDE / terminale animato */}
            <CodeTerminal />
          </div>
        </div>
      </SectionReveal>
